 ...
 */
final class Version20230602125155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT IDENTITY NOT NULL, name VARCHAR(MAX) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE TABLE tourist (id INT IDENTITY NOT NULL, country_id_id INT NOT NULL, passport NVARCHAR(9) NOT NULL, name VARCHAR(MAX) NOT NULL, age SMALLINT NOT NULL, sex BIT NOT NULL, contact NVARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_9891FEDED8A48BBD ON tourist (country_id_id)');
        ...
        $this->addSql('ALTER TABLE tourist ADD CONSTRAINT FK_9891FEDED8A48BBD FOREIGN KEY (country_id_id) REFERENCES country (id)');
    }
